<?php
	...
	class UploadComponent extends Object {
		...
		function upload ($file, $destination, $name = NULL, $rules = NULL, $allowed = NULL) {
			...
			if (!is_null($allowed)) { $this->_allowed = $allowed; } else { $this->_allowed = array('jpg','jpeg','gif','png','csv','pdf','PDF'); }
			...
			//echo"<pre>";Print_r($file);die;
				...
				/*echo "<pre>";
				print_r($this->ext($inputFileName));
				echo "---";
				print_r($this->_allowed);die;*/
