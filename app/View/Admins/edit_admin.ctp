<div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?php echo HTTP_ROOT?>Admins/editAdmin">Forms</a></li>
      </ol>
    </section>
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" id="edit-admin-form" method='post' enctype="multipart/form-data">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="email" class="form-control required email" placeholder="Password" name="data[Admin][email]" value="<?php echo $admin['Admin']['email']?>">
                </div>
                <div class="form-group">
