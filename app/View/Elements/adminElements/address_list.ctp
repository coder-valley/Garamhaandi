...
<div id="page-content">
	<div id="page-content-wrapper" style="padding:0; margin:0; background:0; box-shadow:0 0 0 0 #fff;">
           ...
           <?php $va=count($uid);
			...
			<td style="text-align:center"><?php echo $pr_list['Address']['adress']?></td>
			<!-- <td style="text-align:center"><?php echo $pr_list['Address']['address_type']?></td> -->
			<td style="text-align:center"><?php echo $pr_list['Country']['country_name']?></td>
			...
			<td style="text-align:center"><?php echo $pr_list['Address']['pincode']?></td>
			<!-- <td style="text-align:center"><?php echo $pr_list['Address']['contact_no']?></td> -->
		    	
			<td style="width:150px">

			 <a class="btn_no_text btn ui-state-default ui-corner-all tooltip" title="Edit Address" href="<?php echo HTTP_ROOT.'admin/Users/address_edit/'.base64_encode($pr_list['Address']['id']);?>">
            <i class="fa fa-edit" aria-hidden="true"></i> </a>
             <!-- <a class="btn_no_text btn ui-state-default ui-corner-all tooltip" title="View Dish" href="<?php echo HTTP_ROOT.'admin/Users/view_product/'.base64_encode(convert_uuencode($pr_list['Address']['id']))?>">
                               <span class="ui-icon ui-icon-search"></span>
								                      </a> -->

			 <a title="Delete Address" href="<?php echo HTTP_ROOT.'admin/Users/delete_address/'.base64_encode(convert_uuencode($pr_list['Address']['id']))?>" onclick="if(!confirm('Are you sure, you want to delete this Address?')){return false;}" class="btn_no_text btn ui-state-default ui-corner-all tooltip">
