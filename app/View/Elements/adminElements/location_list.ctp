...
<!-- 						<th title="Sort">Address</th>
           ...
           <?php $va=count($uid);
			...
			<td style="width:150px">
				...
				<a title="Delete Location" href="<?php echo HTTP_ROOT.'admin/Users/delete_location/'.base64_encode(convert_uuencode($pr_list['Location']['id']))?>" onclick="if(!confirm('Are you sure, you want to delete this Location?')){return false;}" class="btn_no_text btn ui-state-default ui-corner-all tooltip">
