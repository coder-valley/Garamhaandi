...
<div id="page-content">
	<div id="page-content-wrapper" style="padding:0; margin:0; background:0; box-shadow:0 0 0 0 #fff;">
           ...
           <?php $va=count($pr);
			...
			?>
			<tr>
			<td class="center"><input type="checkbox" class="checkbox" name="list" value="1" id="<?php echo $pr_list['Menu']['id'];?>"></td>
			...
			<td style="text-align:center"><?php echo $pr_list['Menu']['dish']?></td>

			<td style="text-align:center">Rs. <?php echo $pr_list['Menu']['price']?></td>

			<td style="text-align:center"><?php echo $pr_list['Menu']['category_id']?></td>
			<td style="text-align:center"><?php echo $pr_list['Menu']['subcategory_id'];?></td>
			<td style="text-align:center"><?php echo $pr_list['Menu']['childsubcategory_id']?></td>
			

		    <td style="text-align:center"><img src="<?php echo HTTP_ROOT.'img/dish/'.$pr_list['Menu']['image'] ?>" width="50%" height="10%"></td>
		    	
			<td style="width:150px">

			 <a class="btn_no_text btn ui-state-default ui-corner-all tooltip" title="Edit Dish" href="<?php echo HTTP_ROOT.'admin/Users/edit_product/'.base64_encode(convert_uuencode($pr_list['Menu']['id']));?>">
            <span class="ui-icon ui-icon-pencil"></span> </a>
             <a class="btn_no_text btn ui-state-default ui-corner-all tooltip" title="View Dish" href="<?php echo HTTP_ROOT.'admin/Users/view_product/'.base64_encode(convert_uuencode($pr_list['Menu']['id']))?>">
                               <span class="ui-icon ui-icon-search"></span>
								                      </a>

			 <a title="Delete Dish" href="<?php echo HTTP_ROOT.'admin/Users/delete_product/'.base64_encode(convert_uuencode($pr_list['Menu']['id']))?>" onclick="if(!confirm('Are you sure, you want to delete this Menu?')){return false;}" class="btn_no_text btn ui-state-default ui-corner-all tooltip">
