<div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?php echo HTTP_ROOT?>Forms/addCustomField/<?php echo @$collegeId?>">Add Field</a></li>
      </ol>
    </section>
            ...
            <form role="form" id="add-college-form" method='post' enctype="multipart/form-data">
              <div class="box-body">
                <input type="hidden" class="form-control"  name="data[Form][id]" value="<?php echo @$form['Form']['id']?>">
                 <input type="hidden" class="form-control"  name="data[Form][college_id]" value="<?php echo @$CollegeId?>">
