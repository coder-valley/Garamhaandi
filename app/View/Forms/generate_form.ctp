      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" id="add-college-form" action="<?php echo HTTP_ROOT.'Forms/generateFormData'?>" method='post' enctype="multipart/form-data">
              <div class="box-body">
                <?php $i=1;foreach($allfields as $field){?>
                  <input type="hidden" name="data[Form][<?php echo $i;?>][college_id]" value="<?php echo $field['Form']['college_id']?>">
