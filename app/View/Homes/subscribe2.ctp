...
<div class="row">
  <div class="col-md-2 subsborder" >
    <div class="spanhoversubs" ><a class="asubs" href="<?php echo HTTP_ROOT.'/Homes/subscribe'?>"><h4><b>Basic Details</b></h4></a></div><br>
    <div class="spanhoversubs"><a class="asubs" href="<?php echo HTTP_ROOT.'/Homes/subscribe1'?>"><h4><b>Select Meal</b></h4></a></div><br>
    <div class="spanhoversubs button-clicked" id="buttonsubsonclick"><a class="asubs" href="#"><h4><b>Payment</b></h4></a></div><br>
  </div>
    ...
    <div class="row" style="padding-left: 127px;">
      <div class="col-md-6">
        ...
        <select class="foodpreference">
           <option value="11">11:30am to 12:00pm</option>
           <option value="12">12:00pm to 12:30pm</option>
           <option value="01">12:30pm to 01:00pm</option>
        </select><br><br>
      </div>
      <div class="col-md-6">
        <h6>Mobile Number</h6>
        ...
        <a href="#"><button class="btn btn-primary buttoncolor" style="vertical-align:middle; width: 20%"><span><b>Pay </b></span></button></a>
      </div>
    </div>
  </div>
</div>
