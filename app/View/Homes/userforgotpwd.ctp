...
<div class="container contforgot">
	...
	<div class="row" style="padding-left: 20%;">
		<div class="col-md-12">
			<h6>New Password</h6>
			<h4><input type="text1" name="data[User][new]" placeholder="New password"></h4>
		</div>
	</div>
	<div class="row" style="padding-left: 20%;">
		<div class="col-md-12">
			<h6>Confirm Password</h6>
			<h4><input type="text1" name="data[User][confirm]" placeholder="Re-write new password"></h4>
		</div>
	</div>
</div>
<div class="row" style="padding-top: 7px;padding-bottom: 100px;">
	<div class="col-md-4">
