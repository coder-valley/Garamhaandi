            ...
            <div class="content-box content-box-header" style="border:none;">
                <div class="column-content-box">
                    ...
                    <div class="ui-state-default ui-corner-top ui-box-header">
                        ...
                        <span class="ui-icon float-left ui-icon-notice"></span> Edit Privacy Policy
                    </div>

                    <div class="content-box-wrapper">

                        <form class="forms" id="register" method="post" enctype="multipart/form-data" action="<?php echo HTTP_ROOT;?>admin/Users/edit_privacy_policy">

                            <input type="hidden" name="data[PrivacyPolicy][id]" value="<?php echo $edit_privacy['PrivacyPolicy']['id']?>" />
                            ...
                            <fieldset>
                                <ul>
                                    <li>
                                        ...
                                        <div>
                                            <textarea class="field text full" name="data[PrivacyPolicy][title]" type="text" value="<?php echo $edit_privacy['PrivacyPolicy']['title']?>"></textarea>
                                        </div>
                                    </li>
                                    <li>
                                        ...
                                        <div>
                                            <textarea id="elm4_textarea" name="data[PrivacyPolicy][description]" class="mceEditor mce_editor" style="width:100%;height:250px;">
                                                <?php echo $edit_privacy[ 'PrivacyPolicy'][ 'description']?>
                                            </textarea>
                                        </div>
