...
<div id="page-layout" >
  ...
  <h2 style="width:50%; float:left;">Terms and Conditions</h2>
			...
			<?php echo $this->Html->link('Add Terms&Conditions',array('controller' => 'Users', 'action' => 'add_terms'));?>
		</span>
			</div>
			...
			<?php  echo $this->element('adminElements/term_list');?>
			</div>
