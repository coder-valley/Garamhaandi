	...
	<div id="page_wrapper">
		<div id="page-header">
			<div id="page-header-wrapper">
				<div id="top">
					<a href="#" class="logo" title="Admintasia 2.3">Admintasia 2.3</a>
					<div class="welcome">
			...
			<ul class="drop-down">
				<li>
					...
					<ul id="style-switcher" class="drop-down-container box ui-widget ui-widget-content .ui-corner-tl .ui-corner-tr">
						...
						<li>
							<a id="blue_sky" href="#" class="btn ui-state-default full-link ui-corner-all set_theme" title="Blue Sky Theme">
								<span class="ui-icon ui-icon-zoomin"></span>
								BlueSky Theme
							</a>
						</li>
						...
						<li>
							<a id="salmon" href="#" class="btn ui-state-default full-link ui-corner-all set_theme" title="Salmon  Theme">
								<span class="ui-icon ui-icon-zoomin"></span>
								Salmon  Theme
							</a>
						</li>
						...
						<li>
							<a id="turquoise" href="#" class="btn ui-state-default full-link ui-corner-all set_theme" title="Turquoise  Theme">
								<span class="ui-icon ui-icon-zoomin"></span>
								Turquoise  Theme
							</a>
						</li>									
